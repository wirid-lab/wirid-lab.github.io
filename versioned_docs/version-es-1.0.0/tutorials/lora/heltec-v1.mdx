...
- Abra su cliente VNC
- Para ingresar por este metodo utilice la URL asignada por el laboratorio seguido del puerto destinado para trabajar con VNC 5901 
...
el directorio con Nombre ESP32_Heltec_Libraries, ingresar al mismos y copiar todos los directorios que se encuentran en el subdirectorio **libraries**
