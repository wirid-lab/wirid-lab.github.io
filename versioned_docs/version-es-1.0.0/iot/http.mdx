...
- **{URL}**: ``https://api.wiridlab.site/api/iot/devices/<nodeApiName>``
...
A continuación se mostrarán dos ejemplos utilizando la herramienta POSTMAN
...
:::caution
Si {BODY} o {data_n} no es un array de objetos JSON no se almacenará ninguna información.
:::
:::info
Los datos enviados en el array de objetos serán almacenados de forma independiente.
:::
:::info
...
A continuación encontrará algunos recursos para usar el WIRID-LAB IoT.

### Arduino

### Python

- [Consultar / Publicar datos](https://github.com/wirid-lab/iot-http-api-python)

### Angular

- [Plantilla para consultar datos de nodos IoT](https://github.com/wirid-lab/iot-data-report-angular-template)
